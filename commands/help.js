...
const colors = require("./colors.json");
  ...
  module.exports.run = async (bot, message, args) => {
    ...
    .setColor(colors.green)
    .addField(`***ping***`, "This command shows you your ping.")
    .addField(`***roll***`, "This command will roll you a six sided die, what will you get?")
    .addField(`***8ball <question>*** `, "For this command you must ask a full question. The bot picks from an array of multiple differnet answers.")
    .addField(`***say <word>***`, "This command will make the bot say whatever you input into it. Use this wisely.")
